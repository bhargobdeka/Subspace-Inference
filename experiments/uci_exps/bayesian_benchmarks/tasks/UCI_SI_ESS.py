# -*- coding: utf-8 -*-
"""
Created on Wed Nov 30 10:41:28 2022
...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 28 16:24:20 2022
...
#%% Inference Type
args.inference = 'ess' # Elliptical Slice Sampling

# data_name = ["boston","concrete","energy","yacht",]
data_name = ["yacht"]#,"kin8nm","power","protein"
for j in range(len(data_name)):
    args.dataset  = data_name[j]
    _RESULTS_lltest = "data/"+args.dataset+"/results_SI_ESS/lltest_SI_ESS.txt"
    _RESULTS_RMSEtest ="data/"+args.dataset+"/results_SI_ESS/RMSEtest_SI_ESS.txt"
    #%%
    if args.dataset == 'concrete':
        args.epochs  = 1000
        args.batch_size = 100
        args.lr_init = 1e-03
        # args.noise_var = False
