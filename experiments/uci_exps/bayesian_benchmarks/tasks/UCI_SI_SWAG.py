# -*- coding: utf-8 -*-
"""
Created on Wed Nov 30 14:58:49 2022
...
for j in range(len(data_name)):
    ...
    _RESULTS_lltest = "data/"+args.dataset+"/results_SI_SWAG/lltest_SI_SWAG.txt"
    _RESULTS_RMSEtest ="data/"+args.dataset+"/results_SI_SWAG/RMSEtest_SI_SWAG.txt"
    #%%
