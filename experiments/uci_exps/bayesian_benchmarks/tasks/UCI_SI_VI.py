...
#%% Inference Type
args.inference = 'vi' # Variational Inference
# data_name = ["boston","concrete","energy","yacht", "naval"]
data_name = ["energy"]#,"kin8nm","power","protein"
# data_name = ["naval"]
for j in range(len(data_name)):
    args.dataset  = data_name[j]
    _RESULTS_lltest = "data/"+args.dataset+"/results_SI_VI/lltest_SI_VI.txt"
    _RESULTS_RMSEtest ="data/"+args.dataset+"/results_SI_VI/RMSEtest_SI_VI.txt"
    #%%
